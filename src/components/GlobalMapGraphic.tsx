...
export const GlobalMapGraphic: React.FC = () => {
  return (
    <div className="relative w-full bg-[#1a3d2e] text-[#f4efe6] pt-6 sm:py-8 px-4 sm:px-6 lg:px-8 pb-2">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
        ...
        <div className="lg:col-span-5 space-y-4 sm:space-y-7 text-center">

          {/* ✅ Centered Heading */}
          <div className="flex justify-center">
            <h2 className="font-serif text-xl sm:text-2xl lg:text-3xl font-bold leading-tight text-[#f4efe6] text-center">
              FROM INDIA CONNECTED TO THE WORLD
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-col gap-3 sm:gap-4 pt-1 sm:pt-2 justify-items-start px-8 sm:px-0 sm:items-center lg:items-start">
            {['GCC', 'Europe', 'Africa', 'Asia', 'North America'].map((market) => (
          ...
          <div className="pt-4 sm:pt-6 border-t border-[#c9a227]/20">
            <p className="text-xs uppercase tracking-[0.2em] text-[#c9a227] font-semibold mb-4 text-center lg:text-left">
              Key Export Destinations
            </p>
            <div className="grid grid-cols-2 gap-3 sm:gap-4 justify-items-start px-8 sm:px-0">
              {[
                { flag: '🇪', name: 'UAE' },
                ...
                <div key={country.name} className="flex items-center space-x-2 sm:space-x-3 text-sm sm:text-base font-medium text-[#f4efe6]">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full border border-[#c9a227] flex items-center justify-center shrink-0 bg-[#122b20] text-xs sm:text-sm">
                    {country.flag}
                  </div>
        ...
        <div className="lg:col-span-7 relative w-full -mx-4 sm:mx-0 aspect-[4/3] sm:aspect-[21/12] lg:aspect-[21/10] min-h-[220px] sm:min-h-[320px] flex items-center justify-center">
